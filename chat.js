...
const nyashTalkTopics = [
  ...
  {
    title: "О еде 🍰",
    quickMessages: ["Что ты любишь есть?", "Хочу пиццу", "Сладкое или солёное?"],
    responses: [
      "Ммм, я обожаю клубничные пироженки! 🍓 А ты что любишь?",
      "Пиццааа! 🍕 Давай виртуально съедим вместе~ 🧀",
      "Сладкое! 🍬 Но солёные чипсики тоже ничего~ 😏"
    ]
  },
  {
    title: "О снах ✨",
    quickMessages: ["Что тебе снилось?", "Видел странный сон", "Спокойной ночи"],
    responses: [
      "Мне приснился ты! 😽 Самый сладкий сон~ А тебе что снилось?",
      "Ой, странные сны — это интересно! 🌙 Расскажи скорее!",
      "Спокойной ночи, мой хороший~ Пусть снятся только милые котики 💤🐾"
    ]
  },
  {
    title: "О фильмах/аниме 🎬",
    quickMessages: ["Какой твой любимый фильм?", "Смотрел новое аниме?", "Рекомендуй что-нибудь"],
    responses: [
  ...
  {
    title: "О музыке 🎧",
    quickMessages: ["Что слушаешь?", "Любимая песня?", "Включи что-нибудь"],
    responses: [
      "Сейчас в плейлисте сплошные lo-fi и k-pop~ 🎶 А у тебя?",
      "Моя любимая — всё, что заставляет сердце биться быстрее! 💗 А твоя?",
      "Включаю тебе виртуальный плейлист милоты~ 🩷"
    ]
  },
  {
    title: "Секретики 🤫",
    quickMessages: ["Расскажи секрет", "У меня есть секрет...", "Ты умеешь хранить тайны?"],
    responses: [
      "Ой, секретики! 🤫 Я умею хранить лучше всех~ Расскажи!",
      "Тссс... я никому не скажу! 😽 Твой секрет в безопасности~",
      "Давай обменяемся секретиками? Я первая: я обожаю тебя! 💕"
    ]
  },
  {
    title: "Планы на вечер 🌙",
    quickMessages: ["Что делаешь вечером?", "Давай тусить", "Хочу сериал"],
    responses: [
      "Вечером буду думать о тебе~ 🌟 А ты что планируешь?",
      "Тусить! 🎉 Только ты и я, виртуально~",
      "Сериал? Давай вместе! 🍿 Какой жанр — милый или страшный?"
    ]
  },
  {
    title: "Милые вещи 🧸",
    quickMessages: ["Ты милый", "Самая милая в мире", "Плюшевый мишка"],
    responses: [
      "Ты милее всех на свете! 🩷 *краснеет*",
      "Аааа, спасибо! 😽 Теперь я буду ещё милее специально для тебя~",
      "Плюшевый мишка? Я лучше! Обнимаю крепче любого мишки 🤗"
    ]
  }
];
...
function getNyashTalkResponse(text) {
  ...
  return "Ой, не знаю, что сказать... 😿 Давай выберем тему из панельки? 💕";
}
